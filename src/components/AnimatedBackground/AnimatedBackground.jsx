/* ============================================================
   ...
   Canvas particle system with 3D parallax & mouse interaction
   ============================================================ */
...
function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    /* Each particle has x, y, z (depth), velocity, and a hue */
    const particles = Array.from({ length: PARTICLE_COUNT }, () => ({
      ...
      hue: Math.random() * 80 + 210, // indigo-cyan range
    }));

    /* Project 3D → 2D using perspective */
    function project(p) {
      const fov   = 400;
