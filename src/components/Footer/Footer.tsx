        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-heading font-bold text-lg shadow-[0_0_15px_rgba(99,102,241,0.3)] group-hover:shadow-[0_0_20px_rgba(6,182,212,0.5)] transition-shadow">
                S
              </div>
